...
export default function ProductScreen() {
  ...
  return (
    <View>
      ...
      <Text style={styles.descProducto}>Descripción: {description}.</Text>
      <Text style={styles.infoProducto}>Precio: {price}€</Text>
      <Text style={styles.infoProducto}>Valoración: {rating}</Text>
